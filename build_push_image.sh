...
# penyesuaikan dengan saran ketiga dari submission
# read -p "Masukkan GitHub Access Token: " github_token

# ubah nama image sesuai remote hub
echo -e "\n==== UBAH NAMA IMAGE ===="
docker tag item-app:v1 ghcr.io/$github_username/a433-microservices/item-app:v1
...
docker push ghcr.io/$github_username/a433-microservices/item-app:v1